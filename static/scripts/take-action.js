...
Because of the network of Flock data-sharing, our everyday travel history is spread across all sorts of departments and agencies that we can't keep track of, and even potentially international hackers. Charlottesville city council member Michael Payne raised an excellent point by saying, \"It's a huge problem to have a privately-owned company building a national surveillance system of vehicles and vehicle locations.\"

Police officers have been told to be \"as vague as permissible\" for why they use Flock cameras. According to a 2026 article from the Virginia Center for Investigative Journalism, thousands of automated license plate reader searches by Virginia police gave vague, one-word reasons for the search, like "suspect," "suspicious," or even \"123.\" Weak reasons like these do not promote public safety.

Virginia passed a law regulating Flock cameras, but in a report by the Virginia State Crime Commission, police departments were shown to be breaking this law. Across the state, many police departments shared data with out-of-state and/or federal agencies, kept data longer than the maximum retention period, never promoted public awareness about the cameras, and never even had an internal policy for their usage. All of these are violations of the law, and the report didn't say which departments broke the law. There were no consequences for any departments operating Flock cameras illegally.
